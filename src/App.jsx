...
export default function App() {
  ...
  const generate = useCallback(async () => {
    if (!apiKey) { setError("API key missing. Add VITE_MOONSHOT_API_KEY to Render environment variables."); return; }
  ...
  const generateDaily = useCallback(async () => {
    if (!apiKey) { setDailyError("API key missing. Add VITE_MOONSHOT_API_KEY to Render environment variables."); return; }
